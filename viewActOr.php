...
if($_SESSION['sid'])
{
    ...
    $resultAct = mysqli_query($con,"SELECT * FROM Aktiviti WHERE ID = '".$_SESSION['sid']."' ORDER BY tarikhPermulaan ASC");
...
<body>
    ...
    <!--The activity list-->
    <br><br>
    <a href='insertActOr.php' class='right'>+Tambah aktiviti baru</a><br><br>
    ...
    <?php
        ...
        $sqlAct = "SELECT * FROM Aktiviti WHERE ID = '".$_SESSION['sid']."' LIMIT $this_page_first_result,$results_per_page";
    ...
    <td><a href="viewMoreOr.php?id=<?php echo $rowAct["Nama"]; ?>">Maklumat Lanjut</a></td>
    </tr>
    <?php
    $i++;
    }
    ...
    <?php
        ...
        for($page = 1;$page<=$number_of_pages;$page++){
            echo '<a href = "viewActOr.php?page='.$page.'">'.$page.'</a> ';
        }
        mysqli_close($con);
    ?>
    </div>
