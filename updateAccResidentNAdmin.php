<?php
    ...
    if (isset($_POST['Submit']))
  {
    ...
    $sql = "UPDATE Administrator SET Fname='$fn' ,
...
<head>
    ...
    <title>Kemas Kini Profil Pentadbir</title>
    ...
    <form name="UpdateAcc" method="POST" action="<?php $_PHP_SELF?>">
        ...
        <div>
            ...
            <fieldset>
                ...
                <div class="seven">
                    <input class="r" id="newpw" name="newpw" type="password" style="margin:0;"><br>
                    <input class="r" id="oldpw" name="oldpw" type="password" style="margin:0;"><br>
                    <input class="r" id="rpw" name="rpw" type="password" style="margin:0;"> 
                </div>
            </fieldset>
        </div>
    </form>
