<?php
  ...
  if($_SESSION['sid'])
  {
    ...
    $resultAct = mysqli_query($con,"SELECT * FROM Aktiviti WHERE Nama='".$_GET['id']."' AND Keadaan = '1'");
...
<body>
    ...
    <p align='center'>
    <input name='back' type='button' value='Kembali' class='button' onClick="parent.location='searchAd.php?page=<?php echo $_GET["page"]; ?>&query=<?php echo $_GET["query"]; ?>'"></p>
    </p>
