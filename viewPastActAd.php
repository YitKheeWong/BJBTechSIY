...
<body>
    ...
    <td><a href="viewMorepAd.php?id=<?php echo $rowAct['Nama']; ?>">Maklumat Lanjut</a></td>
    <td><a href="view.FeedbackAd.php?id=<?php echo $rowAct['Nama']; ?>">Maklum Balas</a></td>
    ...
    <?php
        ...
        for($page = 1;$page<=$number_of_pages;$page++){
            echo '<a href = "viewPastActAd.php?page='.$page.'">'.$page.'</a> ';
        }
        mysqli_close($con);
    ?>
    </div>
