...
<div class="nv">
    ...
    <div class='row'>
        ...
        <p align='center'><input name='back' type='button' value='Kembali' class='button' onClick="parent.location='search.php?page=<?php echo $_GET["page"]; ?>&query=<?php echo $_GET["query"]; ?>'"></p>
