...
if($_SESSION['sid'])
{
    ...
    $resultAct = mysqli_query($con,"SELECT * FROM Aktiviti WHERE tarikhPermulaan < CURDATE() AND ID = '".$_SESSION['sid']."' AND Keadaan = '1'");
...
<body>
    ...
    <?php
        ...
        $sqlAct = "SELECT * FROM Aktiviti WHERE tarikhPermulaan < CURDATE() AND ID = '".$_SESSION['sid']."' AND Keadaan = '1' LIMIT $this_page_first_result,$results_per_page";
    ...
    <td><a href="viewMorepOr.php?id=<?php echo $rowAct["Nama"]; ?>">Maklumat Lanjut</a></td>
    <td><a href="view.FeedbackOr.php?id=<?php echo $rowAct["Nama"]; ?>">Maklum Balas</a></td>
    </tr>
    <?php
    $i++;
    }
    ...
    <?php
        ...
        for($page = 1;$page<=$number_of_pages;$page++){
            echo '<a href = "viewPastActOr.php?page='.$page.'">'.$page.'</a> ';
        }
        mysqli_close($con);
    ?>
    </div>
    ...
    <p align='center'>
        <input name='back' type='button' value='Kembali' class='button' onClick="parent.location='indexpo.php'">
    </p>
</body>
</html>