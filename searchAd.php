    ...
    <?php
        ...
        if($queryResult>0){
            while($rowQ = mysqli_fetch_assoc($resultQP)){
                ...
                <td><a href="viewMoreSearchAd.php?id=<?php echo $rowQ["Nama"]; ?>&query=<?php echo $search;?>&page=<?php echo $page;?>">Maklumat Lanjut</a></td>
                </tr>
            <?php
            $i++;
            $j++;
            ...
            echo '<a href = "searchAd.php?page='.$page.'&query='.$search.'">'.$page.'</a> ';
            }
            mysqli_close($con);
            }
            ?>
