...
<body>
    ...
    <div>
        <ul class="upperframe">
            ...
            <li class="mb"><button id="up"><a href="updateAccr.php">KemasKini</a></button></li>
        </ul>
    </div>
    ...
    <div>
        <fieldset class="clearfix">
            ...
            <div class="col">
                ...
                <div class="displayProfile"><a style="color:black;text-decoration: none" href="mailto:<?php echo $row['Email'];?>"><?php echo $row['Email'];?></a></div><br> 
                Admin ID:
                <div class="displayProfile"><?php echo $row['ID'];?></div><br> 
            </div>
            <div class="col">
                ...
                Alamat Rumah: 
                <div class="displayProfile"><?php echo $row['Address'];?></div><br>
            </div>
