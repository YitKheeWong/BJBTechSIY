<?php
  ...
  if($_SESSION['sid'])
  {
    ...
    $resultAct = mysqli_query($con,"SELECT * FROM Aktiviti WHERE Keadaan = '0' ORDER BY tarikhPermulaan ASC");
...
<head>
    ...
    <title>Senarai Permohonan Aktiviti </title>
...
<body>
    ...
    <?php
        ...
        $sqlAct = "SELECT * FROM Aktiviti WHERE Keadaan = '0' LIMIT $this_page_first_result,$results_per_page";
    ...
    <td><a href="viewMoreUnapprovedAd.php?id=<?php echo $rowAct["Nama"]; ?>">Makumat Lanjut</a></td>
    </tr>
    <?php
    $i++;
    }
    ...
    <?php
        ...
        for($page = 1;$page<=$number_of_pages;$page++){
            echo '<a href = "viewUnapprovedActAd.php?page='.$page.'">'.$page.'</a> ';
        }
        mysqli_close($con);
    ?>
    </div>
