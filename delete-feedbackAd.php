...
<head>
    ...
    <title>Hapusan Maklum Balas</title>
...
<body>
    ...
    $sqlFB = "DELETE FROM Feedback WHERE akname='".$_GET['id']."'";
    //Execute query
    if ($con->query($sqlFB) === TRUE) {
        header("Location:view-MoreFeedAd.php?id=".$_GET['id']."&msg=Maklum%20balas%20telah%20berjaya%20dipadamkan.");
    } else {
    ...
    ?>
    <p align="center">
    <input name='back' type='button' value='Kembali' class='button' onClick="parent.location='view.FeedbackAd.php'">
    </p>
