...
<div class="nv">
    ...
    <div class='row'>
        ...
        <!--check if it is terhad, if cnt < bilangan-->
        <?php
        if ($row['Implementasi']=='Terhad') {
            if ($row['Count'] < $row['Bilangan']){
                echo "<p align='center'><input name='join' type='button' value='Sertai' class='button' onClick=\"parent.location='participateActivityguest.php?id=" .$row['Nama']. "'\"></p> ";
            }
            else{
                echo "<p align='center'>Bilangan peserta telah mencapai bilangan maximum.</p>";
            }
        }
        if ($row['Implementasi'] == 'Terbuka'){
            echo "<p align='center'><input name='join' type='button' value='Sertai' class='button' onClick=\"parent.location='participateActivityguest.php?id=" .$row['Nama']. "'\"></p> ";
        }
        ?>
        <p align='center'><input name='back' type='button' value='Kembali' class='button' onClick="parent.location='viewActivity.php'"></p>
