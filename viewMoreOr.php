...
<body>
    ...
    <p align='center'>
        ...
        <input name='plist' type='button' value='Senarai Peserta' class='button' onClick="parent.location='viewParticipantPo.php?id=<?php echo $rowAct['Nama']?>'">
    </p>
    <?php
        if ($rowAct['Keadaan']=='0') {
            echo "<p align='center'>";
                echo "Untuk kemaskini, sila tekan "; 
                echo "<a href='updateActOr.php?id=";
                echo $rowAct['Nama']."'> sini</a>.";

                echo "Untuk padamkan, sila tekan "; 
                echo "<a href='deleteActOr.php?id=";
                echo $rowAct['Nama']."'> sini</a>.";
            echo "</p>";
        }
    ?>
