...
<body>
    ...
    <div class='row'>
        ...
        <?php
        if ($rowAct['Implementasi']=='Terhad') {
            if ($rowAct['Count'] < $rowAct['Bilangan']){
                echo "<p align='center'><input name='join' type='button' value='Sertai' class='button' onClick=\"parent.location='participateActivityr.php?id=" .$rowAct['Nama']. "'\"></p> ";
            }
            else{
                echo "<p align='center'>Bilangan peserta telah mencapai bilangan maximum.</p>";
            }
        }
        if ($rowAct['Implementasi'] == 'Terbuka'){
            echo "<p align='center'><input name='join' type='button' value='Sertai' class='button' onClick=\"parent.location='participateActivityr.php?id=" .$rowAct['Nama']. "'\"></p> ";
        }
        ?>
    <p align='center'>
        <input name='back' type='button' value='Kembali' class='button' onClick="parent.location='viewActivityr.php'">
    </p>
