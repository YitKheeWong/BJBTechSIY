<?php
  ...
  if($_SESSION['sid'])
  {
    ...
    if($numResult>0)
    {
        ...
        window.location.href = "insertActAd.php"
        </script>';
    }
    ...
    VALUES ('$ActName', '$Peserta', '$Implementasi','$Bilangan','$Lokasi','$Negeri','$Postcode','$Penganjur','$tarikhPermulaan','$tarikhTamat','$masaPermulaan','$masaTamat','0','0', '$idAd')";

    //Execute query
    if(mysqli_query($con, $sql)){
    echo '<script>alert("Aktiviti telah berjaya ditambah.")
    window.location.href = "insertQuestionAd.php"
    </script>';
    } else{
...
<body>
    ...
    <form name='insertActivity' method='POST' action='insertActAd.php'>
    <br><br>
    <div class='row'>
        <div class='column'>
