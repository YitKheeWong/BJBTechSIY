<?php
  ...
  if($_SESSION['sid'])
  {
    ...
    if(isset($_POST['submit'])){
        if (mysqli_query($con,"UPDATE Aktiviti set Nama='".$_POST['Nama']."',Peserta='".$_POST['Peserta']."',
...
<head>
    ...
    <title>Kemas Kini Infomasi Aktiviti</title>
...
<body>
    ...
    <br><br>
    <form name='updateActivity' method='POST' action='<?php $_PHP_SELF?>'>
    <br><br>
    <div class='row'>
        <div class='column'>
        Nama Aktiviti:
        <input type="hidden" name="Nama" class="txtField" value="<?php echo $rowAct['Nama'];?>">
        <input disabled type="text" name="Nama" value="<?php echo $rowAct['Nama'];?>" onfocus="colorinput(this)">
        <br><br>
